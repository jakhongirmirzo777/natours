...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(formData, type) {
    var url, _yield$axios$patch, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          ...
          _context.next = 4;
          return _axios.default.patch(url, formData, {
...
var userDataForm = document.querySelector('#credentials-form');
...
if (loginForm) {
  loginForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var email, password, _yield$login, data;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
          ...
          case 6:
            ...
            _jsCookie.default.set('jwt', data.token, {
...
if (passwordForm) {
  passwordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var current_password, new_password, new_password_confirm, _yield$updateSettings, data;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            new_password_confirm = document.getElementById('password-confirm').value;
            _context3.next = 8;
          ...
          case 8:
            _yield$updateSettings = _context3.sent;
            data = _yield$updateSettings.data;
            _jsCookie.default.set('jwt', data.token, {
              expires: new Date(Date.now() + 90 * 24 * 60 * 60 * 1000)
            });
...
if (logoutBtn) {
  logoutBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
...
},{"js-cookie":"../../node_modules/js-cookie/dist/js.cookie.js","./alert":"alert.js","./login":"login.js","./updateSettings":"updateSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9927" + '/');
